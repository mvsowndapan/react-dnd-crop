...
class Dnd extends Component {
  constructor(props) {
    super(props);
    let cropRatio = this.props.cropRatio
  ...
  onImageDrop(e) {
    ...
    if (validUpload) {
      ...
      [...newFiles].forEach(file => validateImage(file, this.getImageDataUrl, this.props.cropRatio));
    }
  }
  ...
  async onInputChange(e) {
    ...
    this.setState({ files }, () => {
      validateImage(file, this.getImageDataUrl, this.props.cropRatio);
    });
